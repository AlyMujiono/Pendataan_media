            ...
            <form method="post" action="" class="form-horizontal" enctype="multipart/form-data">
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                          <input type="text" name="no_urut" class="form-control" id="no_urut" value="<?= $parpol->no_urut; ?>" required>
                        </div>
                    </div>
                    <div class="form-group">
                      <label for="nama_parpol" class="col-sm-2 control-label">Nama Parpol <span class="text-danger">*</span></label>
                      <div class="col-sm-8">
                        <input type="text" name="nama_parpol" class="form-control" id="nama_parpol" value="<?= $parpol->nama_parpol; ?>" required>
                      </div>
                    </div>
                    <div class="form-group">
                        <label for="file_berkas" class="col-sm-2 control-label">Berkas</label>
                        <div class="col-sm-8">
                          <?=anchor('assets/berkas/'.$parpol->file_berkas, '<i class="fa fa-file-pdf-o"></i> View Berkas', 'target="_blank" class="btn btn-sm btn-danger"');?>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="file_berkas" class="col-sm-2 control-label">Ganti Berkas</label>
                        <div class="col-sm-7">
